<template>
  <v-card class="releases">
    <v-card-title class="releases__title">What's New</v-card-title>
    <v-card-text class="releases__list">
      <div class="release">
        <div class="release__date overline">v2.0.0 &mdash; April 8th</div>
        <div class="release__title">Synchronized write-ups with audio playback</div>
        <div class="release__description">
          ...
          <router-link to="/reciters/tejani-brothers/albums/2019" @click.native="$emit('close')">
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn text @click="$emit('close')">Dismiss</v-btn>
      </v-card-actions>
    </v-card-text>
  </v-card>
